...
If you wish to contribute to mntyjs, please be sure to
read/subscribe to the following resources:

 -  [The PSR-2 Coding Standard](http://www.php-fig.org/psr/psr-2/)

If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/mntyjs/issues/new).
...
2. Fork the repository (http://github.com/bitExpert/mntyjs)
3. Clone the canonical repository locally and enter it.

```console
$ git clone git://github.com:bitExpert/mntyjs.git
$ cd mntyjs
```
...
```console
$ git remote add {username} git@github.com:{username}/mntyjs.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical mntyjs repository.
...
To ssh://git@github.com/{username}/mntyjs.git
